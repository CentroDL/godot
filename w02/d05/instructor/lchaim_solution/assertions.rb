...
p1.age! # => 3
assert_that(
  'at the age of 3 a person can hold memories',
...
assert_that(
  'adding an interest adds a memory',
  p1.memories.include?(age: 4, memory: 'got interested in crayons'), true)

# ** continue once the above assertions run **

m1 = Male.new
assert_that("a person can't learn before 4", m1.respond_to?(:learn!), false)
4.times { m1.age! }
# => 8
assert_that(
  'a Schoolable module is added at 4',
  m1.singleton_class.included_modules.include?(Abilities::Schoolable),
  true
)
...
assert_that(
  "...if a person doesn't know something it returns false",
