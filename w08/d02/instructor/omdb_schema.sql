...
-- rules for creating join tables
-- table names pluralized
-- alphabetial order with underscores
-- no id of its own
-- ids referencing the other tables
-- if we had two tables called songs and mixtapes
-- and wanted a many-to-many relationship between them:
